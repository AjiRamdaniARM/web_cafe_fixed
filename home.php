...
<div class="col-lg-9 mt-2">
    ...
    <div class="card mt-4">
        <div class="card-body text-center border-0 bg-light">
            <h5 class="card-title">Onii-Chan Japanese Cuisine</h5>
            <p class="card-text">Aplikasi pemesanan makanan dan minuman restoran khas Jepang. Nikmati beragam menu makanan dan minuman favorit anda dengan beberapa klik. Pesan, bayar, dan lacak pesanan anda dengan mudah melalui aplikasi ini.</p>
